...
- [x] niri config.kdl, source it
- [x] fix display brightness control not working
...
- [x] change the granularity of volume from 10 points to 5 points
- [x] check application level controls
- [ ] check how to make the zen browser better using [zen mods](https://www.youtube.com/watch?v=Hx4QgMLBfr0)
- [x] top bar change the contrast depending on the wallpaper
